...
template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::white_pawn> = 0;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::white_knight> = 2;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::white_bishop> = 2;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::white_rook> = 4;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::white_queen> = 8;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::white_king> = 0;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::black_pawn> = 0;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::black_knight> = 2;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::black_bishop> = 2;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::black_rook> = 4;

template <>
inline constexpr int mid_to_endgame_pc_val<piece_t::black_queen> = 8;
...
inline constexpr std::array<uint64_t, 15> diag_down = {0,
                                                       0x8040,
                                                       0x804020,
                                                       0x80402010,
                                                       0x8040201008,
...
const std::array<const char *, 15> full_piece_names = {
...
const std::array<const char, 12> piece_chars = {
