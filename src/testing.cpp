    ...
    for (int idx = 0; idx < max_draft; idx++) {
      ...
      if (perft == perft_test.second[idx]) {
        ...
        cout << "\tFailed, Draft: " << idx + 1
             << " | Correct Perft: " << perft_test.second[idx]
             << " | This Perft: " << perft << "\n";
      }
    }
...
//     {
//         const vector<vector<string>> pzls =
//         helpers::read_csv(priv::WIN_AT_CHESS_FILE); int idx = 0; int passed =
//         0; count = min(count, 300); for (auto pzl : pzls)
//         {
//             if (idx++ > count)
//             {
//                 break;
...
//             cout << "\n\nRUNNING TESTS: " << pzl[2] << "\n"
//                  << pzl[0] << "\n";
//             const string bot_move =
//             control::get_bot_move_at_depth_algebreic(pzl[0], 7); if (bot_move
//             == pzl[1])
//             {
//                 cout << "\nPASSED [" << pzl[1] << "]\n";
//                 passed++;
...
//             else
//             {
//                 cout << "\nFAILED | Bot Move: [" << bot_move << "] Correct
//                 Move: [" << pzl[1] << "]\n";
//             }
//         }
